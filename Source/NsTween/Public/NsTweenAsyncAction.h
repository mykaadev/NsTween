...
public:
    /** Resolves a valid registration context when the caller omits one. */
    static UObject* ResolveWorldContext(UObject* WorldContextObject);
    ...
    void InitialiseCommon(UObject* WorldContextObject, float InDuration, ENsTweenEase InEase, float InDelay, int32 InLoops, float InLoopDelay, bool bInPingPong, float InPingPongDelay, bool bInCanTickDuringPause, bool bInUseGlobalTimeDilation, UCurveFloat* InCurve, bool bInUseCustomCurve);
...
TAction* CreateAsyncNode(UObject* WorldContextObject, float DurationSecs, ENsTweenEase EaseType, float Delay, int32 Loops, float LoopDelay, bool bPingPong, float PingPongDelay, bool bCanTickDuringPause, bool bUseGlobalTimeDilation, UCurveFloat* Curve, bool bUseCustomCurve, TInitializer&& Initializer)
{
    TAction* Node = NewObject<TAction>();
    UObject* ContextObject = UNsTweenAsyncAction::ResolveWorldContext(WorldContextObject);
